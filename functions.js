...
//If the value passed into our function is eat have the function 
...
var verifyFunction = isNumberGreaterThan(20,10)
...
var verifyFunction = isNumberGreaterThan(20,10);
console.log(verifyFunction);
//alternate code without var is console.log(isNumberGreaterThan(5,1));
...
var verifyIs = isTrue("pig");
console.log(verifyIs);
//without var: console.log(isTrue("cat"));
...
function isEqual (firstWord, secondWord) {
  ...
  else {return "Y U NO MATCH!";

  }
}

var equal = isEqual("dog", "dog");
console.log(equal);
...
console.log(totalUnderWhat(1,5,10,15));
...
var total = 0;   //why do you have this var total set at 0?

function greatSummator(arr){
 for(var i = 0; i<arr.length; i++){
  total +=arr[i]; // total = total + arr 
 }
 return total; //don't get how this adds up the array. there is nothing telling it to add
